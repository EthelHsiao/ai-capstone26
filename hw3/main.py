...
from map_processor import (
    ...
    AUTO_DOOR_MAX_BLOB_AREA,
    DOOR_CLEANUP_MODE,
    DOOR_CARVES,
    FLOOR_FREE_DILATE_RADIUS,
    USE_FLOOR_FREE_SPACE,
    load_and_filter_map,
    select_start,
    get_goal_pixels,
    pixel_to_world,
...
def main():
    ...
    if SHOW_PARAMETERS or VERBOSE:
        print(
            ...
            f"USE_FLOOR_FREE_SPACE={USE_FLOOR_FREE_SPACE}, "
            f"FLOOR_FREE_DILATE_RADIUS={FLOOR_FREE_DILATE_RADIUS}, "
            f"DOOR_CLEANUP_MODE={DOOR_CLEANUP_MODE}, "
            f"AUTO_DOOR_MAX_BLOB_AREA={AUTO_DOOR_MAX_BLOB_AREA}, "
